...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/cesar/Escritorio/OneShelf/backend FLASK/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/cesar/Escritorio/OneShelf/backend FLASK/venv/bin/deactivate.nu'
